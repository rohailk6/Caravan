...
export default function DriverStep2Screen() {
  ...
  const params = useLocalSearchParams(); // ← receives all params from step 1
  ...
  const handleNext = () => {
    ...
    // Pass ALL params forward to step 3
    // ...params keeps vehicle_type, firstName, lastName, dateOfBirth etc.
    router.push({
...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontSize: 16, color: '#4A5568', fontWeight: '600', marginBottom: 12 },
  uploadCard: {
